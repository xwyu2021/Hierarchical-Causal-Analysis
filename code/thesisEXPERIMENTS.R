...
mod = HCAGIBBS_intvt(neID,lambdaM,Yind0,nA,AM,PAind0,npa,
                     ...
                     stages,num.stages,alpha.stage,beta,r,zeta,g,iteration=5000,ID=trainID,intervention=trainINTVT,
                     remedy=trainREMEDY,length_I, num_xr,num_ID=20,sigma,psi) 

require(rlist)
list.save(mod,"data1000ceg1.rds")
L=list.load("data1000ceg1.rds")
plot(1:5000,L$epsilon,lty=1,type="l")
plot(1:5000,L$boundary,lty=1,type="l")

## ••• source and run model 2
source("Desktop/thesis pack/code/thesisMOD2.R")
...
mod = HCAGIBBS_intvt(neID,lambdaM,Yind0,nA,AM,PAind0,npa,
                     ...
                     remedy=trainREMEDY,length_I, num_xr,num_ID=20,sigma,psi) 
require(rlist)
list.save(mod,"data1000ceg2.rds")
L=list.load("data1000ceg2.rds")
plot(1:5000,c(L$epsilon),type="l",lty=1)
plot(1:5000,c(L$boundary),type="l",lty=1)